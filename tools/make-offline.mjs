...
tileData.footmanWalk = dataUri(resolve(root, "public", "gen_footman_walk.jpg"));
tileData.gruntWalk = dataUri(resolve(root, "public", "gen_grunt_walk.jpg"));
tileData.footmanIdle = dataUri(resolve(root, "public", "gen_footman_idle.jpg"));
tileData.gruntIdle = dataUri(resolve(root, "public", "gen_grunt_idle.jpg"));
tileData.gruntAtk = dataUri(resolve(root, "public", "gen_grunt_atk.jpg"));
tileData.dragonFly = dataUri(resolve(root, "public", "gen_dragon_fly.jpg"));
tileData.griffinFly = dataUri(resolve(root, "public", "gen_griffin_fly.jpg"));
tileData.mageCast = dataUri(resolve(root, "public", "gen_mage_cast.jpg"));
tileData.orcCasterCast = dataUri(resolve(root, "public", "gen_orccaster_cast.jpg"));
tileData.mageWalk = dataUri(resolve(root, "public", "gen_mage_walk.jpg"));
tileData.orcCasterWalk = dataUri(resolve(root, "public", "gen_orccaster_walk.jpg"));
tileData.archerWalk = dataUri(resolve(root, "public", "gen_archer_walk.jpg"));
tileData.orcArcherWalk = dataUri(resolve(root, "public", "gen_orcarcher_walk.jpg"));
...
tileData.warcry = dataUri(resolve(root, "public", "gen_warcry.jpg"));
tileData.temple = dataUri(resolve(root, "public", "gen_temple.jpg"));
tileData.barracks = dataUri(resolve(root, "public", "gen_barracks.jpg"));
tileData.townhall = dataUri(resolve(root, "public", "gen_townhall.jpg"));
tileData.farm = dataUri(resolve(root, "public", "gen_farm.jpg"));
tileData.sawmill = dataUri(resolve(root, "public", "gen_sawmill.jpg"));
tileData.forge = dataUri(resolve(root, "public", "gen_forge.jpg"));
tileData.tower = dataUri(resolve(root, "public", "gen_tower.jpg"));
...
tileData.knightAtk = dataUri(resolve(root, "public", "gen_knight_atk.jpg"));
tileData.wolfriderAtk = dataUri(resolve(root, "public", "gen_wolfrider_atk.jpg"));
